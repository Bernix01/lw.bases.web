...
if (isset($_POST["cod_deposito"])){
    ...
    $facturas = $factura_colector->getFacturasByCodDeposito($_POST["cod_deposito"]);
    ?>
    <!DOCTYPE html>
    <html>
    <head>
                    ...
                    <div class="panel panel-primary filterable">
                        ...
                        <table class="table" id="testcase">
                            ...
                            <tr class="filters">
                                ...
                                <th><input type="text" class="form-control" placeholder="id del estudiante" disabled>
                                </th>
                        ...
                        <form role="form" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="cod_deposito">Código de depósito</label>
                                    <input type="text" required="required" minlength="16" maxlength="16"
                                           class="form-control" name="cod_deposito"
                                           placeholder="Ingresar código de depósito">
                                </div>
