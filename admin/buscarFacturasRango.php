  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="listarFacturas.php">Listado de facturas</a></li>
        <li class="active">Reporte facturas</li>
      </ol>
    </section>
    ...
    <table class="table" id="testcase" >
        ...
        <thead>
            <tr class="filters">
                ...
                <th><input type="text" class="form-control" placeholder="Id_estudiante" disabled></th>
        ...
        <tbody>
                  ...
                  foreach ($facturas as $f){
                      echo "<tr><td>" . $f->get_numero_factura() . "</td>";
                                            echo "<td>" . $f->get_nombres() . "</td>";
                                            echo "<td>" . $f->get_apellidos() . "</td>";
                                            echo "<td>" . $f->get_cupos(). "</td>";
                                            echo "<td>" . $f->get_total(). "</td>";
                                            echo "<td>" . $f->get_ruc(). "</td>";
                                            echo "<td>" . $f->get_id_estudiante(). "</td>";
                                            echo "<td>" . $f->get_fecha(). "</td>";
                                            echo "<td>" . $f->get_direccion(). "</td>";
...
<?php
  ...
  header("location: buscarFacturasPorFecha.php");
}
?>
